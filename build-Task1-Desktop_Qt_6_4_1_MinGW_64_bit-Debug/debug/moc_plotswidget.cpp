...
namespace {
struct qt_meta_stringdata_PlotsWidget_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_PlotsWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_PlotsWidget_t qt_meta_stringdata_PlotsWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_PlotsWidget[] = {
...
Q_CONSTINIT const QMetaObject PlotsWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_PlotsWidget.offsetsAndSizes,
    qt_meta_data_PlotsWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_PlotsWidget_t,
        // Q_OBJECT / Q_GADGET
...
void *PlotsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PlotsWidget.stringdata0))
